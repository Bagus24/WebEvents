<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="{{ url('/home') }}">
        <img src="{{ asset ('public/dist_argon/assets/img/brand/blue.png') }}" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('showJadwal') }}">
              <i class="ni ni-bullet-list-67 text-red"></i> Jadwal
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('showAkun') }}">
